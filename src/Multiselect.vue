      ...
      >
        ...
        >
          ...
          <li class="multiselect__element"
              v-bind:id="id + '-' + index"
              v-bind:role="!(item && (item.$isLabel || item.$isDisabled)) ? 'option' : null">
            <span
                v-if="!(item && (item.$isLabel || item.$isDisabled))"
                :class="optionHighlight(index, item)"
                @click.stop="select(item)"
                @mouseenter.self="pointerSet(index)"
                :data-select="item && item.isTag ? tagPlaceholder : selectLabelText"
                :data-selected="selectedLabelText"
                :data-deselect="deselectLabelText"
                class="multiselect__option">
                  <slot name="option" :option="item" :search="search" :index="index">
            ...
            <span
                ...
                :class="groupHighlight(index, item)"
...
export default {
  ...
  props: {
    ...
    /**
     * Sets height value of the virtual item
     * @default 40
     * @type {Integer}
     */
    virtualItemHeight: {
